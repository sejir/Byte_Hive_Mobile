...
public class EquipementVendre {
    ...
    public EquipementVendre() {
     ...
     public EquipementVendre( String nomEquipement, String prixEquipement, String descriptionEquipement, String imageEquipement,String quantiteEquipement,int idFournisseur,double rating) {
